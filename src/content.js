const content = {
    ...
    cta: 'Let us talk',
      ...
      aboutPrinciples: [ {
        ...
        },
        {
          ...
          description: 'Our work connects flows, people, and tools to build resilient systems that keep working as things change.'
        },
        {
      ...
      aboutPrinciples: [
        {
          ...
          description: "Identificamos lacunas, riscos e pontos de atrito enquanto ainda há tempo para agir. Fazemos as perguntas que muitos evitam — as que incomodam um pouco, mas evitam grandes problemas depois."
        },
        {
          title: "Desenhamos para a continuidade",
          description: "Nosso trabalho conecta fluxos, pessoas e ferramentas para criar sistemas resilientes que continuam funcionando mesmo quando tudo muda."
        },
        {
          title: "Definimos o problema antes de resolver",
        ...
        },
        {
          ...
          description: "Trabalhamos com as pessoas, não ao redor delas. As trazemos para a conversa, mesmo quando fica confuso. Boas ideias nascem de escuta profunda e entendimento compartilhado, não de cargos."
        }
          ],
  ...
  bullets: {
    en: [
      ...
      'Internal tools and workflow interfaces',
      'Process automation & implementation support',
      'Developer collaboration and knowledge transfer'
    ],
    pt: [
